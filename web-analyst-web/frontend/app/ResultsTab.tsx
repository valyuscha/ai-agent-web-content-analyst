...
export default function ResultsTab({ analysis, reportMarkdown }: ResultsTabProps) {
  if (!analysis) {
    return (
      <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center min-h-[50vh] sm:min-h-0" style={{ height: 'calc(100vh - 16rem)' }}>
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 flex flex-col" style={{ minHeight: '50vh', height: 'calc(100vh - 16rem)' }}>
      <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">Analysis Results</h2>
